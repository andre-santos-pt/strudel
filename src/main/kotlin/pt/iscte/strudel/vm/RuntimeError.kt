...
enum class RuntimeErrorType {
    NULL_POINTER, ARRAY_INDEX_BOUNDS, NEGATIVE_ARRAY_SIZE, NONINIT_VARIABLE, INFINTE_CYCLE, STACK_OVERFLOW, OUT_OF_MEMORY, VALUE_OVERFLOW, ASSERTION, BUILT_IN_PROCEDURE, UNSUPPORTED
}
